...
public class SessionManager {
    ...
    public void guardarSesion(String username, String password, String nombreCompleto) {
        editor.putBoolean(KEY_LOGGED, true);
        editor.putString(KEY_USERNAME, username);
        editor.putString(KEY_PASSWORD, password);
        editor.putString(KEY_NOMBRE, nombreCompleto != null ? nombreCompleto : username);
        editor.apply();
    }
